...
// gcc -D_FILE_OFFSET_BITS=64 -I/usr/include/fuse   -g -O2 -c -o bbfs.o bbfs.c
// gcc -D_FILE_OFFSET_BITS=64 -I/usr/include/fuse   -g -O2 -c -o log.o log.c
// gcc -D_FILE_OFFSET_BITS=64 -I/usr/include/fuse   -g -O2   -o bbfs bbfs.o log.o -pthread -lfuse   

// Clean:
// test -z "bbfs" || rm -f bbfs
// rm -f *.o
